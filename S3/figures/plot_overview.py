...
# ---------- Global title ----------
fig.suptitle("Evaluation Results – S3 (Parallel Cooperation Environment)", fontsize=15, fontweight="bold")

# === Save figure ===
save_path = os.path.join(FIG_DIR, "S3_overview_results.png")
