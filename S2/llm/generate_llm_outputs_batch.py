...
MODEL_CONFIGS = {
    "small": {"name": "llama3.2:1b"},
    "middle": {"name": "gemma3:4b"},
    "large": {"name": "qwen3:8b"}
}
...
def main():
    ...
    parser.add_argument("--model", type=str, choices=["small", "middle", "large"], required=True)
    ...
    print(f"=== Generating S2 outputs using {model_name} ({args.model}) — deterministic mode ===")
