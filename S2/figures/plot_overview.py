...
# Extract model order and metrics
...
# ---------- Global title ----------
fig.suptitle("Evaluation Results – S2 (Sequential Dual-Robot Environment)", fontsize=15, fontweight="bold")

# === Save figure ===
save_path = os.path.join(FIG_DIR, "S2_overview_results.png")
